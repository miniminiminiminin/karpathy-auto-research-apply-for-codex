...
5. do not start editing `project/` until the rubric exists
...
4. promotion decides keep, discard, or escalate
5. memory records what changed, what failed, and what to try next
