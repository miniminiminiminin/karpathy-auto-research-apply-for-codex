...
- treat files under `CANON/canon-compilation/packages/**` as editable package sources when working on reusable package behavior
...
2. copy `CANON/canon-compilation/packages/research-scaffold/**` into that downstream root
...
- run `node CANON/canon-compilation/packages/research-scaffold/scripts/validate-scaffold.mjs <downstream-root>` after bootstrap and before promotion claims
